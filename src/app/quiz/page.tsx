...
const Quiz = () => {
    return (
        ...
        <form name="quiz" className="container">
            ...
            <ul className="m-8 bg-amber-50 p-4 text-justify">
                ...
                <b className="bg-blue-600 text-white"> 2. Theo Điều lệ Hội liên hiệp Phụ nữ Việt Nam thì Hội liên hiệp
                    Phụ nữ Việt Nam là tổ chức gì?</b>
                <ul>
                    <li>
                    ...
                    <b className="bg-blue-600 text-white"> 3. : Đại hội đại biểu Phụ nữ toàn quốc lần thứ XIII dự kiến
                        ...
                        và bao nhiêu chương trình?</b>
                    <ul>
                        <li>
                            <input name="q3" type="radio" value="A"/>A) Ít nhất 05 chính sách, đề án và 02 chương trình.

                        </li>
                        <li>
                            <input name="q3" type="radio" value="B"/>B) Ít nhất 04 chính sách, đề án và 03 chương trình.

                        </li>
                        <li>
                            <input name="q3" type="radio" value="C"/>C) Ít nhất 03 chính sách, đề án và 02 chương trình.

                        </li>
                        <li>
                            <input name="q3" type="radio" value="D"/>D) Ít nhất 02 chính sách, đề án và 05 chương trình.
            ...
            <div className="text-center bg-red-400 my-5 px-2 py-4 mx-48">
                <h1 className="font-bold  text-2xl">
                    Kết quả</h1>
                <input type="text" classname="text-center" value="5/10"/> Điểm
            </div>
